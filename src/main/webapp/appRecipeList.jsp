                    ...
                    <c:forEach var="recipe" items="${recipeList}">
                        <tr class="d-flex">
                            ...
                            <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                <a href="<c:url value="/app/recipe/safeDelete?recipeId=${recipe.ID}"/>" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                ...
                                <a href="<c:url value="/app/recipe/edit?recipeId=${recipe.ID}"/>" class="btn btn-info rounded-0 text-light m-1">Edytuj</a>
