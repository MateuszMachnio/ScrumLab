            ...
            <div class="mt-4 ml-4 mr-4">
                ...
                <table class="table borderless">
                    ...
                    <tr class="d-flex">
                        ...
                        <td class="col-7"><textarea name="description" id="description" class="w-100 p-1" rows="5"
                                                    required></textarea></td>
                    </tr>
                    <tr class="d-flex">
                        <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                        <td class="col-3">
                            <input class="p-1" name="preparationTime" id="preparationTime" type="number" value=""
                                   required>
                        </td>
                    </tr>
                    </tbody>
